...
class TestMarginalVaR:
    def test_basic(self):
        mvar = marginal_var(portfolio_var=100.0, portfolio_std=20.0, exposure_contribution_to_std=5.0)
