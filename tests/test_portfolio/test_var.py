...
class TestHistoricalSimulationVaR:
    ...
    def test_deterministic_small_sample(self) -> None:
...
class TestCornishFisherVaR:
    ...
    def test_zero_skew_kurtosis_equals_parametric(self) -> None:
    ...
    def test_positive_skew_increases_var(self) -> None:
    ...
    def test_excess_kurtosis_increases_var(self) -> None:
        normal_var = cornish_fisher_var(el=100, ul_std=50, skewness=0.0, kurtosis=0.0)
...
class TestIncrementalVaR:
    ...
    def test_positive_when_exposure_increases_risk(self) -> None:
        np.random.seed(42)
    ...
    def test_empty_combined_raises(self) -> None:
        with pytest.raises(ValueError, match="non-empty"):
...
class TestComponentVaR:
    ...
    def test_sums_to_portfolio_var(self) -> None:
        portfolio_var = 100.0
        portfolio_std = 40.0
    ...
    def test_zero_portfolio_std_returns_zeros(self) -> None:
