...
class TestAssessSICR:
    def test_dpd_backstop_triggers(self):
        assert assess_sicr(0.01, 0.01, days_past_due=31) is True

    def test_dpd_backstop_disabled(self):
    ...
    def test_relative_change_below_threshold(self):
    ...
    def test_no_sicr(self):
        assert assess_sicr(0.01, 0.01) is False

    def test_zero_origination_pd(self):
