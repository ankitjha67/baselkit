...
class TestGetOutputFloorPct:
    ...
    def test_india_conservative_80pct(self):
        assert get_output_floor_pct(Jurisdiction.INDIA, date(2023, 6, 1)) == 0.80

    def test_unknown_jurisdiction_falls_back_to_bcbs(self):
...
class TestOutputFloorCalculator:
    ...
    def test_eu_transitional_cap(self):
